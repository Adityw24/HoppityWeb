        ...
        <div className="relative mx-auto max-w-7xl px-6 py-6 lg:px-10">
          <header className="flex items-center justify-between rounded-full border border-white/60 bg-white/75 px-5 py-3 backdrop-blur-xl shadow-sm">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-2xl">
                <img src="./src/assets/logo1.png" alt="Hoppity Logo" />
              </div>
              <div>
                <p className="text-lg font-semibold tracking-tight">Hoppity</p>
                <p className="text-xs text-slate-600">Discover Real Travel</p>
              </div>
            </div>
            <nav className="hidden items-center gap-6 text-sm text-slate-700 md:flex">
              <a href="#why" className="hover:text-violet-700">Why Hoppity</a>
              <a href="#catalog" className="hover:text-violet-700">Itineraries</a>
              <a href="#stories" className="hover:text-violet-700">Stories</a>
              <a href="#waitlist" className="hover:text-violet-700">Join Waitlist</a>
            </nav>
          </header>
          ...
          <div className="grid items-center gap-12 py-16 lg:grid-cols-[1.15fr_0.85fr] lg:py-24">
            <div>
              ...
              <h1 className="max-w-4xl text-5xl font-black leading-[0.95] tracking-[-0.04em] text-slate-950 md:text-7xl">
      ...
      <section id="catalog" className="mx-auto max-w-7xl px-6 py-12 lg:px-10 lg:py-20">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {itineraries.map((trip) => (
            <div key={trip.title} className="group overflow-hidden rounded-[2rem] border border-violet-100 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-2xl">
